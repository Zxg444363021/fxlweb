...
<script type="text/javascript">
    $(function () {
        $(".dateprev").click(function () {
            location.href = "JieHuanFenXi.aspx?date=<%=DateTime.Parse(today).AddYears(-1).ToString("yyyy") %>-<%=DateTime.Parse(today).ToString("MM-dd") %>&type=month";
        });
...
<div id="content">
    ...
    <table cellspacing="0" border="0" style="width:100%;" class="tabledate">
        <tr>
            ...
            <td style="width:26%;"><a href="javascript:void(0)" class="dateprev">&lt;上年</a>&nbsp;&nbsp;&nbsp;<strong>日期：</strong><%=DateTime.Parse(Session["TodayDate"].ToString()).ToString("yyyy年") %>&nbsp;&nbsp;<img src="/Images/Others/calendar.png" alt="" title="" />&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" class="datenext">下年&gt;</a></td>
