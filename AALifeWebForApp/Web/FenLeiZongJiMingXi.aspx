<%@ Page Title="消费分类明细" Language="C#" MasterPageFile="UserControl/MasterPage.master" AutoEventWireup="true" CodeFile="FenLeiZongJiMingXi.aspx.cs" Inherits="FenLeiZongJiMingXi" %>
...
<script type="text/javascript">
    ...
    function chart_click(index) {
        location.href = "ItemNumDetail.aspx?url=<%=Server.UrlEncode(Request.Url.ToString()) %>&" + arrChart[index];
    }
</script>
</asp:Content>
    ...
    <div class="maindiv">
        ...
        <table cellspacing="0" border="1" style="width:100%;" class="tablelist">
            ...
            <tr>
                ...
                <td><a href="ItemNumDetail.aspx?url=<%=Server.UrlEncode(Request.Url.ToString()) %>&itemName=<%# Eval("ItemName") %>&itemType=<%# Eval("ItemTypeValue") %>&catTypeId=<%# Eval("CategoryTypeID") %>">查看详细</a></td>
            </tr>
            </ItemTemplate>
            <FooterTemplate>
            <tr>
