                ...
                <asp:GridView ID="AdminList" runat="server" AutoGenerateColumns="False" CssClass="usertable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="头像">
                            <ItemTemplate>
                                <asp:Image ID="UserImageCon" runat="server" CssClass="lazyimg" ImageUrl='Images/Others/loading.gif' data-original='<%# Regex.IsMatch(Eval("UserImage").ToString(), "^http") ? Eval("UserImage") : "Images/Users/" + Eval("UserImage") %>' Width="50px" Height="50px" />
                            </ItemTemplate>
                            <EditItemTemplate>
