...
<div id="content">
    ...
    <div class="maindiv userdiv">
        <table cellspacing="0" border="0" style="width:100%;" class="tableuser tablelogin">
            ...
            <tr>
                <th>预算率％</th>
                <td><asp:TextBox ID="CategoryRate" runat="server" onkeyup="this.value=this.value.replace(/[^0-9\.\-]/g,'');if(this.value.split('.').length>2||this.value.split('-').length>2||this.value.indexOf('-')>0)this.value='';" MaxLength="10"></asp:TextBox><em><asp:Label ID="Label7" runat="server" CssClass="error"></asp:Label></em></td>
            </tr>
            <tr>
                <th></th>
