...
<div id="content">
    ...
    <div class="maindiv userdiv">
        ...
        <table cellspacing="0" border="0" style="width:100%;" class="tableuser">
            ...
            <tr>
                <th>商品价格</th>
                <td><asp:TextBox ID="ItemPrice" runat="server" onkeyup="this.value=this.value.replace(/[^0-9\.\-]/g,'');if(this.value.split('.').length>2||this.value.split('-').length>2||this.value.indexOf('-')>0)this.value='';" MaxLength="10"></asp:TextBox></td>
            ...
            <tr class="region2">
                <th></th>
                <td colspan="2"><div class="smartitem smartregion" style="padding-left:0;"><p class="rd">每天</p><p class="rw">每周</p><p class="rm on">每月</p><p class="ry">每年</p><p class="rb">工作日</p></div><asp:HiddenField ID="RegionTypeHid" runat="server" Value="m" /></td>
            </tr>
            <tr class="region2">
                <th>购买日期</th>
