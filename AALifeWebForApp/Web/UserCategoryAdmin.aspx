...
<div id="content">
    ...
    <table cellspacing="0" border="0" style="width:100%;" class="tabledate">
        <tr>
            <td>类别预警范围计算：先由【预算x(预算率/100)】得出值，再根据预算加减值得出范围。&nbsp;&nbsp;&nbsp;&nbsp;<a href="UserAdmin.aspx">预算率设置 >></a></td>
        </tr>
    </table>
    <div class="maindiv">
        <asp:GridView ID="CatTypeList" runat="server" AutoGenerateColumns="False" CssClass="tablelist"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="预算">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="CatTypePriceBox" runat="server" Text='<%# Bind("CategoryTypePrice", "{0:0.###}") %>' onkeyup="this.value=this.value.replace(/[^0-9\.\-]/g,'');if(this.value.split('.').length>2||this.value.split('-').length>2||this.value.indexOf('-')>0)this.value='';" MaxLength="10"></asp:TextBox>
                    </EditItemTemplate>
                    <HeaderStyle Width="20%" />
                </asp:TemplateField>
        ...
        <table cellspacing="0" border="1" style="width:100%;" class="tablelist tableadd">
            <tr>
                ...
                <td style="width:20%;"><asp:TextBox ID="CatTypePriceEmpIns" runat="server" onkeyup="this.value=this.value.replace(/[^0-9\.\-]/g,'');if(this.value.split('.').length>2||this.value.split('-').length>2||this.value.indexOf('-')>0)this.value='';" MaxLength="10"></asp:TextBox></td>
                <td style="width:20%;"></td>
