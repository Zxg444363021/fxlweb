...
public class Message
{
    ...
    public static void SendMessageOld(string name, string from, string img)
    {
        try
        {
            ...
            smtp.Credentials = new NetworkCredential("67936108@qq.com", "");
            ...
            mm.Subject = "AA生活记账 - " + "欢迎" + ItemHelper.GetUserFrom(from) + "用户" + name;
    ...
    {
        string str = "AA生活记账 - " + "欢迎" + ItemHelper.GetUserFrom(from) + "用户" + name;
        return str;
    }
}