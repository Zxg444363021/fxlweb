...
<table cellspacing="0" border="0" style="width:100%;" class="tabledate">
    <tr>
        ...
        <td style="width:25%;"><a href="javascript:void(0)" id="datepicker"><strong>日期：</strong><%=DateTime.Parse(Session["TodayDate"].ToString()).ToString("yyyy年MM月") %>&nbsp;&nbsp;<img src="/Images/Others/calendar.png" alt="" title="" /></a></td>
