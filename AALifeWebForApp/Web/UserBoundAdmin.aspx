        ...
        <table cellspacing="0" border="1" style="width:100%;" class="tablelist">
            ...
            <asp:Repeater ID="BoundList" runat="server">
                ...
                <tr>
                    ...
                    <td><%# ItemHelper.GetUserFrom(Eval("OAuthFrom").ToString()) %></td>
                    <td><asp:LinkButton ID="Button3" Visible='<%# Eval("OAuthFrom").ToString() == Session["UserFrom"].ToString() ? false : true %>' runat="server" Text="解除" OnCommand="Button3_Command" CommandArgument='<%# Eval("OAuthID") + "," + Eval("OldUserID") %>'></asp:LinkButton></td>
                </tr>
                </ItemTemplate>
                <FooterTemplate>
                <tr>
