        ...
        <div id="Left" style="width:100%;">
            <div id="ItemList">  
                <table cellspacing="0" border="1" style="width:100%;border-collapse:collapse;" class="detailtable">
                    ...
                    <tr>
                        <td>网站贴士</td>
                        <td><asp:TextBox ID="SiteTipsBox" runat="server" TextMode="MultiLine" Width="500" Height="70"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>公告版本</td>
                        <td><asp:TextBox ID="MessageCode" runat="server" Width="500"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>网站公告</td>
                        <td><asp:TextBox ID="SiteMessage" runat="server" TextMode="MultiLine" Width="500" Height="70"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>手机公告</td>
                        <td><asp:TextBox ID="PhoneMessage" runat="server" TextMode="MultiLine" Width="500" Height="70"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
