...
<script type="text/javascript">
    $(function () {
        $("#BakDateBox").datepicker({
            showOtherMonths: true,
            selectOtherMonths: true
        }); 
        $("#BakDateBox2").datepicker({
            showOtherMonths: true,
            selectOtherMonths: true
        });
    });
...
<div id="Box">
    ...
    <div id="Main">
        <div id="Left" style="width:100%;">
            <div id="ItemList">
                <div>
                    <asp:TextBox ID="BakDateBox" runat="server" Width="80px"></asp:TextBox>
                    <asp:TextBox ID="BakDateBox2" runat="server" Width="80px"></asp:TextBox>
                    ...
                    <asp:Button ID="Button4" runat="server" Text="恢复" OnCommand="Button4_Click" CssClass="btninput" UseSubmitBehavior="false" OnClientClick="return confirm('确定要恢复吗？');" />
