    ...
    <div class="maindiv">
            ...
            <Columns>
                <asp:TemplateField HeaderText="选择">
                    ...
                    <EditItemTemplate>
                        ...
                        <asp:HiddenField ID="RegionIDHid" runat="server" Value='<%# Eval("RegionID") %>' />
                        <asp:HiddenField ID="RegionTypeHid" runat="server" Value='<%# Eval("RegionType") %>' />
                    </EditItemTemplate>                            
                    <HeaderStyle Width="7%" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="分类" SortExpression="ItemType">
                    <EditItemTemplate>
                        ...
                        <asp:HiddenField ID="ItemTypeIDHid" runat="server" Value='<%# Eval("ItemTypeValue") %>' />
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="商品名称" SortExpression="ItemName">
                    ...
                    <ItemTemplate>
                        <div class="cellregion"><asp:Label ID="ItemNameLab" runat="server" Text='<%# Eval("ItemName") %>'></asp:Label>
                            ...
                            <asp:HyperLink ID="Label14" runat="server" CssClass="zhuantiname" Visible='<%# Int32.Parse(Eval("ZhuanTiID").ToString()) > 0 %>' Text='专' NavigateUrl="UserZhuanTi.aspx" ToolTip="专题列表"></asp:HyperLink>
                        </div>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="价格" SortExpression="ItemPrice">
                    <EditItemTemplate>
                        ...
                        <asp:HiddenField ID="ItemPriceHid" runat="server" Value='<%# Eval("ItemPrice", "{0:0.###}") %>' />
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="推荐" SortExpression="Recommend">
                    <EditItemTemplate>
                        ...
                        <asp:HiddenField ID="RecommendHid" runat="server" Value='<%# Eval("Recommend") %>' />
                    </EditItemTemplate>
                    <ItemTemplate>
        ...
        <table cellspacing="0" border="1" style="width:100%;" class="tablelist tableadd">
            <tr>
                ...
                <td style="width:12%;" class="cellprice"><asp:TextBox ID="ItemPriceEmpIns" runat="server" onkeyup="this.value=this.value.replace(/[^0-9\.\-]/g,'');if(this.value.split('.').length>2||this.value.split('-').length>2||this.value.indexOf('-')>0)this.value='';" MaxLength="10"></asp:TextBox></td>
