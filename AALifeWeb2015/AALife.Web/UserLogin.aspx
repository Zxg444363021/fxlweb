    ...
    <div class="maindiv">
        ...
        <table cellspacing="0" border="0" style="width:100%;" class="tableuser tablelogin">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="UserName" runat="server" MaxLength="12"></asp:TextBox></td>
            </tr>
            <tr>
                <th>密　码</th>
                <td><asp:TextBox ID="UserPassword" runat="server" TextMode="Password" MaxLength="12"></asp:TextBox></td>
            </tr>
            <tr>
                <th></th>
                <td></td>
